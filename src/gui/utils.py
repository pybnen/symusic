...
from music_vae.music.settings import MELODY_PROGRAMS, PIANO_MIN_MIDI_PITCH, PIANO_MAX_MIDI_PITCH
from music_vae.music import melody_lib

from gui.globals import STEPS_PER_BAR, MELODY_LENGTH, audio_dir
...
def melody_to_audio(melody, midi_program=0):
    ...
    midi_path = audio_dir + unique_filename + ".mid"
    audi_path = audio_dir + unique_filename + ".wav"
